...
@section('breadcrump')
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Kelas Aktif Prodi</li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Setting Kelas Semester Aktif</h3>
                  <hr>                  
                </div><!-- /.box-header -->
                ...
                <div class="box-header">                  
                      <form id="formKelasProdi" class="form-horizontal" role="form" method="POST" action="{{ action('Kelas\KelasController@kelasRegister')}}");>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-4">
                              ...
                              <button type="submit" class="btn btn-danger" id="button-reg">
                                  REGISTRASIKAN KELAS SEMESTER AKTIF
                              </button>
                          </div>
