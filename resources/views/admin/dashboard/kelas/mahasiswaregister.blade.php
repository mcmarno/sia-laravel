                    ...
                    <tbody>
                     <?php foreach ($mahasiswa as $itemKelas):  ?>
                      <tr>
                        ...
                        <td><font size="4"><span class="{{{($itemKelas->mhsKelompok=='KPT') ? 'label label-info' : 'label label-warning'}}}">{{$itemKelas->mhsKelompok}}</span></font></td>
                        <td><font size="4"><span class="{{{($itemKelas->mhsGolongan=='KPT') ? 'label label-info' : 'label label-warning'}}}">{{$itemKelas->mhsGolongan}}</span></font></td>
