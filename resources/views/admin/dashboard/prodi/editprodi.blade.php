            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      ...
                      <div class="form-group">
                          <label class="col-md-4 control-label">Inisial Program Studi </label>
                          <div class="col-md-6">
                              <input type="text" class="form-control" name="prodiKodeLabel" value="{{$prodiKodeLabel}}">
                              <small class="help-block"></small>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" class="form-control" name="prodiJjarKode" value="{{$prodiJjarKode}}">
                              <small class="help-block"></small>
                          </div>
                      </div>
