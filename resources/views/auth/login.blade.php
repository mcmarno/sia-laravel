    ...
    <center>
      <div id="loginWrapper">
         <div id="loginBox">    
            ...
            <div id="loginBoxhead_img"><img src="{{ URL::asset('auth/images/logo1.png') }}" alt="" width="45" height="45" /> <img src="{{ URL::asset('auth/images/logo2.png') }}" alt="" width="45" height="45" /></div>
                <h1>STT-STIE Gempol</h1>
            </div>
